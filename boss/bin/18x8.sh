mkdir -p 18x8 
for image in 4*.jpg; do convert $image -resize x256 -quality 75 18x8/$image; done

cd 18x8
for image in 4*.jpg; do convert $image -gravity center -crop 512x256+0+0 $image; done
