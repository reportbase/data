for image in unto1/IMG_0064.JPG; do convert $image -gravity center -brightness-contrast 45x15 -crop +150+100 -crop -400-100 $(basename -- "$image") ; done
...
#for image in *.JPG; do convert $image -rotate 90 -quality 70  -resize x1080 $(basename -- "$image") ; done
