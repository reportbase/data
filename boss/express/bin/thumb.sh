...
convert ../../0440.0280.000.gif -font DejaVu-Sans-Bold -pointsize 18 -coalesce -gravity South -background white -splice 0x72 -annotate +0+30 "$1" -gravity south -annotate +0+5 "$2"  ../../0440.0280.gif
...
convert ../../0300.0360.000.gif -font DejaVu-Sans-Bold -pointsize 18 -coalesce -gravity South -background white -splice 0x72 -annotate +0+30 "$1" -gravity south -annotate +0+5 "$2"  ../../0300.0360.gif
...
convert ../../0220.0280.000.gif -font DejaVu-Sans-Bold -pointsize 18 -coalesce -gravity South -background white -splice 0x72 -annotate +0+30 "$1" -gravity south -annotate +0+5 "$2" ../../0220.0280.gif
...
convert ../../0180.0220.000.gif -font DejaVu-Sans-Bold -pointsize 18 -coalesce -gravity South -background white -splice 0x72 -annotate +0+30 "$1" -gravity south -annotate +0+5 "$2" ../../0180.0220.gif
