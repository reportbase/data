...
#montage orig/*.jpg -tile 12x1 -mode Concatenate 012.0%02d.jpg 2> /dev/null
#montage orig/*.jpg -tile 18x1 -mode Concatenate 018.0%02d.jpg 2> /dev/null
#montage orig/*.jpg -tile 24x1 -mode Concatenate 024.0%02d.jpg 2> /dev/null
#montage orig/*.jpg -tile 36x1 -mode Concatenate 036.0%02d.jpg 2> /dev/null
