mkdir -p 36x1 
for image in 4*.jpg; do convert $image -resize x1024 -quality 75 36x1/$image; done

cd 36x1
for image in 4*.jpg; do convert $image -gravity center -crop 320x1024+0+0 $image; done
...
montage {4360..4395}.jpg -tile 36x1 -mode Concatenate 0010.jpg 2> error
montage {4396..4431}.jpg -tile 36x1 -mode Concatenate 0011.jpg 2> error
